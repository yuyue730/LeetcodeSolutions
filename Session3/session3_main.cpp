...
#include <iostream>
#include "session3_test.h"
using namespace std;

int main() {
    cout << "Leetcode Session 3 Problem Solution Application starts.\n";
    Session3Test * testObj = new Session3Test();
    ...
    testObj->numberOfPatterns351Test();
